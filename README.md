...
SIBIL is a package that couples SOLPS-ITER and the BOUT++ elm-6f model. The package  includes python wrapper/I:O scripts to read SOLPS-ITER simulations, create BOUT++ simulations, and check for convergence.
